...
def test_group_topic_personality_binding():
    """Group topic personality should be forwarded on the event."""
    from gateway.platforms.base import MessageType
    ...
    assert event.auto_skill == "software-development"
    assert event.topic_personality == "marvin"


def test_dm_topic_defaults_personality_to_marvin():
    """DM topics default to the Marvin personality when none is configured."""
    from gateway.platforms.base import MessageType
